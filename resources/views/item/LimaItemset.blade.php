...
<div class="col-md-12 padding-0">
    @if ($total > 0 && $cek)
    <button id="btn" style="margin-bottom:15px;" onclick="Calculate()" type="button" class="btn btn-primary"><i class="fa fa-calculator"></i> Buat 5-Itemset</button>
    @endif
