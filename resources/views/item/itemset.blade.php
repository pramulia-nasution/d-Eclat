...
<div class="col-md-12 padding-0">
    @if ($count > 0 && $countset <= 0)
    <button id ="btn" style="margin-bottom:15px;" onclick="Calculate()" type="button" class="btn btn-primary"><i class="fa fa-calculator"></i> Buat 1-Itemset</button>
    @endif
